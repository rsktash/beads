-- Migration 0007 — path to area map (SQLite; Postgres is identical apart from
-- INTEGER PRIMARY KEY AUTOINCREMENT -> BIGSERIAL PRIMARY KEY and
-- INSERT OR IGNORE -> INSERT ... ON CONFLICT (kind, name) DO NOTHING).
...
INSERT OR IGNORE INTO path_area_map (kind, name, root, paths) VALUES
