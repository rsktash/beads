-- Migration 0006 — explicit binds + blocks inheritance (Postgres).
ALTER TABLE statements ADD COLUMN IF NOT EXISTS binds_id TEXT REFERENCES issues(id);
...
SELECT
    ...
    s.filed_by,
    s.evidence,
    'self'::TEXT AS origin_kind,
    NULL::TEXT AS origin_issue_id,
    0::INTEGER AS depth
FROM deduped d
