...
type CreateIssueParams struct {
	...
	IsTemplate         int64        `json:"is_template"`
...
func (q *Queries) NextChildIndex(ctx context.Context, parentID string) (int64, error) {
	row := q.db.QueryRowContext(ctx, nextChildIndex, parentID)
	var last_child int64
...
func (q *Queries) NextCounterID(ctx context.Context, prefix string) (int64, error) {
