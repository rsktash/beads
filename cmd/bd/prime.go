...
- Query: ` + "`bd rulings`" + `, ` + "`bd rulings --scope project`" + `, ` + "`bd question list [<id>] [--status answered|retracted|superseded]`" + ` (the blocked frontier, read-only, open to executors), ` + "`bd settled <keywords>`" + `, ` + "`bd statements backfill`" + `.
